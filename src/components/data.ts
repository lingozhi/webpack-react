function RunExcelJSExport() {
    ...
    const workbookName = "Sample Workbook Generated by ExcelJS.xlsx";
    const worksheetName = "Demo Worksheet";
    const worksheetName2 = "2nd Demo Worksheet";
    const ws = wb.addWorksheet(worksheetName, {
        properties: {
            tabColor: { argb: "FFFF0000" },
        },
    });
    const ws2 = wb.addWorksheet(worksheetName2);
    ...
    const totCell = "B" + (data.length + 2);
    const totFormula = "SUM(B2:B" + (data.length + 1) + ")";
